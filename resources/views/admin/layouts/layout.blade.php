...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="../../index3.html" class="nav-link">Парсеры</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Сергей Пупков</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('sellers.index') }}" class="nav-link">
                            ...
                            <p class="text">Продавцы</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('brands.index') }}" class="nav-link">
                            <i class="nav-icon far fa-circle text-success"></i>
                            <p class="text">Бренды</p>
                        </a>
                    </li>
                </ul>
            </nav>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2022 <a href="{{ url('/') }}">SZ & Co.</a> </strong> Все права защищены.
    </footer>
...
@if ($errors->any())
<div id="toastsContainerTopRight" class="toasts-top-right fixed" style="min-width: 25%;">
    <div class="toast bg-danger fade show" style="max-width: 100%;" role="alert" aria-live="assertive" aria-atomic="true">
...
@if (session()->has('success'))
    <div id="toastsContainerTopRight" class="toasts-top-right fixed" style="min-width: 25%;">
        <div class="toast bg-success fade show" style="max-width: 100%;" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <strong class="mr-auto">Хорошая работа</strong>
                <small>Закрыть</small>
                <button data-dismiss="toast" type="button" class="ml-2 mb-1 close" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
...
<script>
    $(function() {
        setTimeout(function (){
            $('.toasts-top-right').fadeOut();
        }, 5000);

        $('button.close').on('click', function (){
            $(this).closest('.toasts-top-right').fadeOut();
        });
    });
</script>
@endif
